    ...
    <div>
        ...
        <div class="mt-4">
            <div class="flex flex-wrap -mx-6">
                ...
                <button class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0 " >
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white bg-green-200">
                        ...
                        <div class="mx-5">
                            <div @click="redirect('createReservation')">
                                <div class="text-green-600">New Reservation</div>
                            </div>
                        </div>
                    </div>
                </button>
                ...
                <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white bg-indigo-200">
                        ...
                        <div class="mx-5">
                            <span class="text-blue-500 opacity-75" v-if="isLoading">
                ...
                <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white bg-orange-200" >
                        ...
                        <div class="mx-5">
                            ...
                            <div v-else>
                                ...
                                <div class="text-gray-500">Total Cancellations</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                    <table class="min-w-full">
                        ...
                        <tr v-for="reservation in reservations" v-else>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10" >
                                        <img class="h-10 w-10 rounded-full" :src="reservation.car.image" alt="" v-if="reservation.car.image">
                                        <img class="h-10 w-10 rounded-full"  src="https://user-images.githubusercontent.com/194400/49531010-48dad180-f8b1-11e8-8d89-1e61320e1d82.png" alt="" v-else>
                                    </div>

                                    <div class="ml-4">
                                        <div class="text-sm leading-5 font-medium text-gray-900" v-html="reservation.car.brand"></div>
                                        <div class="text-sm leading-5 text-gray-500" v-html="reservation.car.model"></div>
                                    </div>
                                </div>
                            </td>

                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-900" v-html="reservation.start_date"></div>
                                <div class="text-sm leading-5 text-gray-500" v-html="reservation.finish_at"></div>
                            </td>

                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800"  v-if="reservation.cancelled_at !== null">Cancelled</span>
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800" v-else>Awaiting</span>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                <button class="text-white px-4 w-auto h-8 bg-blue-600 rounded-full hover:bg-blue-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none" @click="redirect('updateReservation', {id: reservation.id})">
                                    <span>Edit</span>
                                </button>

                                <button class="text-white px-4 w-auto h-8 bg-orange-600 rounded-full hover:bg-orange-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none" @click="cancel(reservation.id)"  v-if="!reservation.cancelled_at">
                                    <span>Cancel</span>
                                </button>
                            </td>
                        </tr>
