                    ...
                    <table class="min-w-full">
                        ...
                        <tr v-for="reservation in reservations" v-else>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                <button class="text-white px-4 w-auto h-8 bg-red-600 rounded-full hover:bg-red-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none">
                                    <span>Edit</span>
                                </button>

                                <button class="text-white px-4 w-auto h-8 bg-red-600 rounded-full hover:bg-red-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none" @click="cancel(reservation.id)"  v-if="!reservation.cancelled_at">
                                    <span>Cancel</span>
                                </button>
                            </td>
                        </tr>
